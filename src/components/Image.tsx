...
import { AdvancedImage, placeholder as cldPlaceholder, lazyload, responsive } from '@cloudinary/react'
...
export const Image: React.FC<IAvatar> = ({ height = 200, width = 200, style, src, useNextImageInDevelopment }) => {
